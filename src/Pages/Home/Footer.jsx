  ...
  return (
    <footer className="footer--container">
      ...
      <div className="footer--link--container">
        ...
        <div className="footer--social--icon">
          <ul>
            <li>
              <a
                href="https://www.facebook.com/profile.php?id=100008499736456"
            ...
            <li>
              <a
                href="https://www.instagram.com/christy.h_0315/"
                className="navbar--content"
                target="_blank"
                rel="noreferrer"
              >
            ...
            <li>
              <a
                href="https://x.com/christyyy0315?s=21&t=b_HNZxUqVbl1r_wpL3BhtA"
                className="navbar--content"
                target="_blank"
                rel="noreferrer"
              >
            ...
            <li>
              <a
                href="https://www.linkedin.com/in/christy-ho-505893252/"
                className="navbar--content"
                target="_blank"
                rel="noreferrer"
              >
      ...
      <div className="footer--content--container">
        <p className="footer--content">Made by Christy</p>
        {/* Footer navigation */}
        <div className="footer--social--icon">
          <ul>
            <li>
